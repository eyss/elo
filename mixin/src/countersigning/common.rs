 ...
 * 
 * 4. If this is the case, Bob responds with PublishGameResultResponse::OutdatedLastGameResult, 
 *      and Alice tries again with the new latest_game_result for Bob.
 */
...
pub(crate) fn build_game_result_preflight(
    ...
    let times = session_times_from_millis(3_000)?;
